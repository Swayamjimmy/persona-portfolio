      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-12 relative z-10">
        ...
        >
          ...
          <div className="relative group mt-4">
            ...
            {/* Main Content Box */}
            <div
              className="relative bg-persona-white p-6 sm:p-10 border-4 border-persona-black text-persona-black"
              style={{
                clipPath:
                  "polygon(0 0, 100% 2%, 98% 100%, 2% 98%)",
              }}
            >
              ...
              <h1 className="font-p5-block text-5xl sm:text-6xl mb-6 mt-2 tracking-wide uppercase">
                About Me
              </h1>
        ...
        >
          ...
          <div>
            ...
            <h2 className="font-p5-block text-4xl sm:text-5xl text-persona-white mb-8 border-b-4 border-persona-white pb-2 inline-block">
              History
            </h2>
                  ...
                  <div className="absolute -top-4 -left-4 z-30 -rotate-3">
                    <span
                      className="
                        ...
                        bg-persona-black
                        border-2
                        border-persona-white
                        px-3
                        py-1
                        shadow-[2px_2px_0px_rgba(255,255,255,1)]
                        group-hover:bg-persona-red
                        group-hover:border-persona-black
                        group-hover:text-persona-black
                        transition-colors
                        inline-block
                      "
                    >
                    ...
                    <div className="relative z-10 p-6 pt-9 sm:pt-8">
                      ...
                      {item.description && (
                        <p
                          className="
                            font-p3-sleek
                            text-persona-white/90
                            mt-3
                            border-t-2
                            border-persona-white/20
                            pt-3
                          "
                        >
                          {item.description}
