...
export default function ConfidantEasterEgg() {
  ...
  // Track client-side mounting for the Portal
  ...
  return (
    <>
      ...
      {/* Note: \uD83C\uDCC3 (🃃) doesn't render well on all OS platforms. You might want to swap it for 🃏 if it shows up as an empty box. */}
      <button
        onClick={handleClick}
      ...
      {/* Full-screen Confidant Rank Up modal teleported to document.body */}
